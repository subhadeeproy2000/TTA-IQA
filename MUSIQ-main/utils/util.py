...
def RandShuffle(config):
    ...
    if config.scenes == 'all':
        if config.db_name == 'PIPAL':
            scenes = list(range(5600))
        elif config.db_name == 'LIVE':
            # scenes = list(range(29))
            scenes = list(range(779))
        elif config.db_name == 'LIVEc':
            scenes = list(range(1162))
        elif config.db_name == 'KonIQ-10k':
            scenes = list(range(10073))
        elif config.db_name == 'livefb':
            scenes = list(range(39810))
        elif config.db_name == 'cid':
            scenes = list(range(475))
        elif config.db_name == 'tid2013':
            scenes = list(range(3000))
        elif config.db_name == 'dslr':
            scenes = list(range(1035))
