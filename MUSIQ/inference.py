...
config = Config({
    ...
    'dirname': '/home/user/Subhadeep/TRes/Dataset/KONIQ',     # directory of data root
    'checkpoint': './weights/fblive1_epoch10.pth',                              # weights of trained model
...
for filename in tqdm(filenames):
    ...
    if ext == '.jpg':
        ...
        d_img_org = cv2.resize(d_img_org, dsize=(512, 512), interpolation=cv2.INTER_CUBIC)
